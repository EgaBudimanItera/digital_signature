...
$config['cachedir'] 	= 'assets/tmp/cache/'; //string, the default is tmp/cache/
$config['imagedir'] 	= 'assets/tmp/qr_codes/'; //string, the default is tmp/qr_codes/
$config['errorlog'] 	= 'assets/tmp/logs/'; //string, the default is tmp/logs/
